...
splitter = RecursiveCharacterTextSplitter(
    chunk_size=300, chunk_overlap=70, 
)
...
reduce_prompt = PromptTemplate.from_template("Combine the following summaries into a single coherent summary:\n{context}")
reduce_chain = reduce_prompt | llm | StrOutputParser()

prepare_reduce_input = RunnableLambda(lambda summaries: {"summaries": "\n".join(summaries)})
